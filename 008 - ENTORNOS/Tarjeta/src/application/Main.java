...
public class Main extends Application {
	/** Number of branches on Christmas tree. */
	    ...
	    * Draw stump of tree.
	    * 
	    * @param path Path to add bottom of tree and stump to.
	    * @param startingY Y portion where bottom is to start.
	   ...
	   {
	      final Text text1 = new Text(25, 125, "Feliz\nNavidad!");  
	      text1.setFill(Color.DARKGREEN);  
	      text1.setFont(Font.font("Comic Sans MS", FontWeight.BOLD, FontPosture.REGULAR, 40));
	      group.getChildren().add(text1);
	 
	      final Text text2 = new Text(600, 150, "2021");
	      text2.setFill(Color.DARKGREEN);
	      text2.setFont(Font.font("Comic Sans MS", FontWeight.BOLD, FontPosture.REGULAR, 70));
	   ...
	   {
	      stage.setTitle("Tarjeta Navideña");
	      final Group rootGroup = new Group();
	      final Scene scene = new Scene(rootGroup, 800, 600, Color.ORANGERED);
