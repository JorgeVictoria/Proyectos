...
import com.jovian.chat01.adapter.MessagingAdapater
import com.jovian.chat01.model.Message
import com.jovian.chat01.utils.Constants.CHANNEL_ID
import com.jovian.chat01.utils.Constants.CHANNEL_NAME
import com.jovian.chat01.utils.Constants.NOTIFICATION_ID
import com.jovian.chat01.utils.Constants.PENDING_REQUEST
import com.jovian.chat01.utils.Constants.RECEIVE_ID
import com.jovian.chat01.utils.Constants.SEND_ID
import com.jovian.chat01.utils.Time
import kotlinx.coroutines.*

/**
 * clase principal para la gestion de envio y recepcion de mensajes, asi como de las notificaciones
 */
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var adapter: MessagingAdapater
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intentFilter = IntentFilter("com.jovian.key.chat02")
    ...
    private fun makeIntent(message: String): Intent? {
        ...
        val intento = Intent()
        intento.putExtra("chat01", message)
        intento.action = "com.jovian.key.chat01"
    ...
    class MyBroadcastReceiver : BroadcastReceiver() {
        ...
        override fun onReceive(contexto: Context, intent: Intent) {
            ...
            context = contexto
            val data = intent!!.getStringExtra("chat02")
    ...
    private fun makeNotificaton(s: String?) {
        ...
        with(builder) {
            ...
            setContentTitle("Chat02").color = Color.RED
