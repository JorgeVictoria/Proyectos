...
public class AgendaController extends Main {
	...
	/**
	 * Este metodo lo utilizamos para prueba. Por ejemplo, para añadir objetos Persona al cargar la aplicacion.
	 */
	 ...
	 * @param event: Listener que recoge el click sobre el boton del menú
	 *
	 */
	@FXML
	...
	/**
	 * metodo para mostrar por consola el historial de la pantalla ayuda
	 * @param event
	 */
	public void mostrarHistorial(ActionEvent event) {
		...
		if(entries != null) {
			...
			while(iterator.hasNext()) {
				...
				System.out.println(url + " " + title + " " + lastVisitedDate.toString());
			}
		}
		
		else System.out.println("No hay nada que mostrar en el historial");
