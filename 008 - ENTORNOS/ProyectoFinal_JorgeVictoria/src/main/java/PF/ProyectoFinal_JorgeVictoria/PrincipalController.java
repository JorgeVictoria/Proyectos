...
public class PrincipalController{ //creamos una entrada para crear la copia de la entrada
	...
	@FXML
	void imprimirInforme() throws JRException {
		
		Map<String, Object> parameters = new HashMap<String, Object>();
		
		
		InputStream is = Main.class.getResourceAsStream("EntradasVendidas.jrxml");
		JasperReport report = JasperCompileManager.compileReport(is); 
		JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(entradasVendidas); 
		JasperPrint print = JasperFillManager.fillReport(report, parameters, dataSource); 
		JasperExportManager.exportReportToPdfFile(print, "ventas.pdf");
